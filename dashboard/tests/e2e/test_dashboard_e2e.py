...
def run_flask_app():
    ...
    app.template_folder = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'templates')
    app.static_folder = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'static')
...
class TestDashboardE2E:
    ...
    @pytest.mark.asyncio
    async def test_websocket_reconnection(self, page: Page, app_url: str, flask_server, websocket_server):
