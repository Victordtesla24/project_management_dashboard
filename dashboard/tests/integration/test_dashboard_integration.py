...
def config_path(tmp_path):
    config = {
        ...
        "metrics": {"collection_interval": 1, "enabled_metrics": ["cpu", "memory", "disk"]},
        "logging": {"level": "INFO", "file": "dashboard.log"},
    }
...
class TestDashboardIntegration:
    ...
    async def test_config_update_propagation(self, config_path):
        ...
        with patch("dashboard.websocket.server.InfluxDBClient") as mock_influx:
            ...
            assert metrics_ws.enabled_metrics == {"cpu", "memory"}
            ...
            with open(config_path) as f:
                ...
                assert set(saved_config["metrics"]["enabled_metrics"]) == {"cpu", "memory"}
        ...
        with patch("dashboard.websocket.server.InfluxDBClient") as mock_influx:
            ...
            with pytest.raises(SchemaValidationError):
                await metrics_ws.config_manager.update_config(
                    {"metrics": {"collection_interval": -1}}  # Invalid value
                )
