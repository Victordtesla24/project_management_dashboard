...
class TemplatesService(_BaseService):
    ...
    def apply_template(self, template_apply, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.apply_template_with_http_info(template_apply, **kwargs)
        else:
            return self.apply_template_with_http_info(template_apply, **kwargs)
    ...
    def _apply_template_prepare(self, template_apply, **kwargs):
        local_var_params = locals()

        all_params = ["template_apply"]
        ...
        if "template_apply" not in local_var_params or local_var_params["template_apply"] is None:
            msg = "Missing the required parameter `template_apply` when calling `apply_template`"
            raise ValueError(
                msg,
            )
    ...
    def create_stack(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.create_stack_with_http_info(**kwargs)
        else:
            return self.create_stack_with_http_info(**kwargs)
    ...
    def _create_stack_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["post_stack_request"]
    ...
    def delete_stack(self, stack_id, org_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_stack_with_http_info(stack_id, org_id, **kwargs)
        else:
            return self.delete_stack_with_http_info(stack_id, org_id, **kwargs)
    ...
    def _delete_stack_prepare(self, stack_id, org_id, **kwargs):
        local_var_params = locals()

        all_params = ["stack_id", "org_id"]
        ...
        if "stack_id" not in local_var_params or local_var_params["stack_id"] is None:
            msg = "Missing the required parameter `stack_id` when calling `delete_stack`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'org_id' is set
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            msg = "Missing the required parameter `org_id` when calling `delete_stack`"
            raise ValueError(
                msg,
            )
    ...
    def export_template(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.export_template_with_http_info(**kwargs)
        else:
            return self.export_template_with_http_info(**kwargs)
    ...
    def _export_template_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["template_export_by_id"]
    ...
    def list_stacks(self, org_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.list_stacks_with_http_info(org_id, **kwargs)
        else:
            return self.list_stacks_with_http_info(org_id, **kwargs)
    ...
    def _list_stacks_prepare(self, org_id, **kwargs):
        local_var_params = locals()

        all_params = ["org_id", "name", "stack_id"]
        self._check_operation_params("list_stacks", all_params, local_var_params)
        # verify the required parameter 'org_id' is set
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            msg = "Missing the required parameter `org_id` when calling `list_stacks`"
            raise ValueError(
                msg,
            )
        ...
        if "stack_id" in local_var_params:
            query_params.append(("stackID", local_var_params["stack_id"]))
    ...
    def read_stack(self, stack_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.read_stack_with_http_info(stack_id, **kwargs)
        else:
            return self.read_stack_with_http_info(stack_id, **kwargs)
    ...
    def _read_stack_prepare(self, stack_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'stack_id' is set
        if "stack_id" not in local_var_params or local_var_params["stack_id"] is None:
            msg = "Missing the required parameter `stack_id` when calling `read_stack`"
            raise ValueError(
                msg,
            )
    ...
    def uninstall_stack(self, stack_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.uninstall_stack_with_http_info(stack_id, **kwargs)
        else:
            return self.uninstall_stack_with_http_info(stack_id, **kwargs)
    ...
    def _uninstall_stack_prepare(self, stack_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'stack_id' is set
        if "stack_id" not in local_var_params or local_var_params["stack_id"] is None:
            msg = "Missing the required parameter `stack_id` when calling `uninstall_stack`"
            raise ValueError(
                msg,
            )
    ...
    def update_stack(self, stack_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_stack_with_http_info(stack_id, **kwargs)
        else:
            return self.update_stack_with_http_info(stack_id, **kwargs)
    ...
    def _update_stack_prepare(self, stack_id, **kwargs):
        local_var_params = locals()

        all_params = ["stack_id", "patch_stack_request"]
        self._check_operation_params("update_stack", all_params, local_var_params)
        # verify the required parameter 'stack_id' is set
        if "stack_id" not in local_var_params or local_var_params["stack_id"] is None:
            msg = "Missing the required parameter `stack_id` when calling `update_stack`"
            raise ValueError(
                msg,
            )
