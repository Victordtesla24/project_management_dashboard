...
class DBRPsService(_BaseService):
    ...
    def delete_dbrpid(self, dbrp_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.delete_dbrpid_with_http_info(dbrp_id, **kwargs)
        else:
            return self.delete_dbrpid_with_http_info(dbrp_id, **kwargs)
    ...
    def _delete_dbrpid_prepare(self, dbrp_id, **kwargs):
        local_var_params = locals()

        all_params = ["dbrp_id", "zap_trace_span", "org_id", "org"]
        ...
        if "dbrp_id" not in local_var_params or local_var_params["dbrp_id"] is None:
            msg = "Missing the required parameter `dbrp_id` when calling `delete_dbrpid`"
            raise ValueError(
                msg,
            )
        ...
        if "dbrp_id" in local_var_params:
            path_params["dbrpID"] = local_var_params["dbrp_id"]
    ...
    def get_dbr_ps(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_dbr_ps_with_http_info(**kwargs)
        else:
            return self.get_dbr_ps_with_http_info(**kwargs)
    ...
    def _get_dbr_ps_prepare(self, **kwargs):
        local_var_params = locals()
        ...
        if "bucket_id" in local_var_params:
            query_params.append(("bucketID", local_var_params["bucket_id"]))
        ...
        if "rp" in local_var_params:
            query_params.append(("rp", local_var_params["rp"]))
    ...
    def get_dbr_ps_id(self, dbrp_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_dbr_ps_id_with_http_info(dbrp_id, **kwargs)
        else:
            return self.get_dbr_ps_id_with_http_info(dbrp_id, **kwargs)
    ...
    def _get_dbr_ps_id_prepare(self, dbrp_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'dbrp_id' is set
        if "dbrp_id" not in local_var_params or local_var_params["dbrp_id"] is None:
            msg = "Missing the required parameter `dbrp_id` when calling `get_dbr_ps_id`"
            raise ValueError(
                msg,
            )
    ...
    def patch_dbrpid(self, dbrp_id, dbrp_update, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.patch_dbrpid_with_http_info(dbrp_id, dbrp_update, **kwargs)
        else:
            return self.patch_dbrpid_with_http_info(dbrp_id, dbrp_update, **kwargs)
    ...
    def _patch_dbrpid_prepare(self, dbrp_id, dbrp_update, **kwargs):
        local_var_params = locals()

        all_params = ["dbrp_id", "dbrp_update", "zap_trace_span", "org_id", "org"]
        self._check_operation_params("patch_dbrpid", all_params, local_var_params)
        # verify the required parameter 'dbrp_id' is set
        if "dbrp_id" not in local_var_params or local_var_params["dbrp_id"] is None:
            msg = "Missing the required parameter `dbrp_id` when calling `patch_dbrpid`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'dbrp_update' is set
        if "dbrp_update" not in local_var_params or local_var_params["dbrp_update"] is None:
            msg = "Missing the required parameter `dbrp_update` when calling `patch_dbrpid`"
            raise ValueError(
                msg,
            )
    ...
    def post_dbrp(self, dbrp_create, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_dbrp_with_http_info(dbrp_create, **kwargs)
        else:
            return self.post_dbrp_with_http_info(dbrp_create, **kwargs)
    ...
    def _post_dbrp_prepare(self, dbrp_create, **kwargs):
        local_var_params = locals()

        all_params = ["dbrp_create", "zap_trace_span"]
        self._check_operation_params("post_dbrp", all_params, local_var_params)
        # verify the required parameter 'dbrp_create' is set
        if "dbrp_create" not in local_var_params or local_var_params["dbrp_create"] is None:
            msg = "Missing the required parameter `dbrp_create` when calling `post_dbrp`"
            raise ValueError(
                msg,
            )
