...
class DashboardsService(_BaseService):
    ...
    def delete_dashboards_id(self, dashboard_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.delete_dashboards_id_with_http_info(dashboard_id, **kwargs)
        else:
            return self.delete_dashboards_id_with_http_info(dashboard_id, **kwargs)
    ...
    def _delete_dashboards_id_prepare(self, dashboard_id, **kwargs):
        local_var_params = locals()

        all_params = ["dashboard_id", "zap_trace_span"]
        self._check_operation_params("delete_dashboards_id", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = (
        ...
        if "dashboard_id" in local_var_params:
            path_params["dashboardID"] = local_var_params["dashboard_id"]
    ...
    def _delete_dashboards_id_cells_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "cell_id", "zap_trace_span"]
        self._check_operation_params("delete_dashboards_id_cells_id", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `delete_dashboards_id_cells_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'cell_id' is set
        if "cell_id" not in local_var_params or local_var_params["cell_id"] is None:
            msg = "Missing the required parameter `cell_id` when calling `delete_dashboards_id_cells_id`"
            raise ValueError(
                msg,
            )
        ...
        if "cell_id" in local_var_params:
            path_params["cellID"] = local_var_params["cell_id"]
    ...
    def _delete_dashboards_id_labels_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "label_id", "zap_trace_span"]
        self._check_operation_params("delete_dashboards_id_labels_id", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `delete_dashboards_id_labels_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'label_id' is set
        if "label_id" not in local_var_params or local_var_params["label_id"] is None:
            msg = "Missing the required parameter `label_id` when calling `delete_dashboards_id_labels_id`"
            raise ValueError(
                msg,
            )
    ...
    def _delete_dashboards_id_members_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["user_id", "dashboard_id", "zap_trace_span"]
        ...
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `delete_dashboards_id_members_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `delete_dashboards_id_members_id`"
            raise ValueError(
                msg,
            )
    ...
    def _delete_dashboards_id_owners_id_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'user_id' is set
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `delete_dashboards_id_owners_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `delete_dashboards_id_owners_id`"
            raise ValueError(
                msg,
            )
    ...
    def _get_dashboards_prepare(self, **kwargs):
        local_var_params = locals()
        ...
        if "offset" in local_var_params and local_var_params["offset"] < 0:
            msg = "Invalid value for parameter `offset` when calling `get_dashboards`, must be a value greater than or equal to `0`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] > 100:
            msg = "Invalid value for parameter `limit` when calling `get_dashboards`, must be a value less than or equal to `100`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] < 1:
            msg = "Invalid value for parameter `limit` when calling `get_dashboards`, must be a value greater than or equal to `1`"
            raise ValueError(
                msg,
            )
        path_params = {}
        ...
        if "descending" in local_var_params:
            query_params.append(("descending", local_var_params["descending"]))
    ...
    def get_dashboards_id(self, dashboard_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_dashboards_id_with_http_info(dashboard_id, **kwargs)
        else:
            return self.get_dashboards_id_with_http_info(dashboard_id, **kwargs)
    ...
    def get_dashboards_id_with_http_info(self, dashboard_id, **kwargs):
        ...
        return self.api_client.call_api(
            ...
            post_params=[],
            files={},
            response_type="DashboardWithViewProperties",
            auth_settings=[],
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
    ...
    def _get_dashboards_id_prepare(self, dashboard_id, **kwargs):
        local_var_params = locals()

        all_params = ["dashboard_id", "zap_trace_span", "include"]
        self._check_operation_params("get_dashboards_id", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `get_dashboards_id`"
            raise ValueError(
                msg,
            )
        ...
        if "include" in local_var_params:
            query_params.append(("include", local_var_params["include"]))
    ...
    def _get_dashboards_id_cells_id_view_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `get_dashboards_id_cells_id_view`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'cell_id' is set
        if "cell_id" not in local_var_params or local_var_params["cell_id"] is None:
            msg = "Missing the required parameter `cell_id` when calling `get_dashboards_id_cells_id_view`"
            raise ValueError(
                msg,
            )
    ...
    def _get_dashboards_id_labels_prepare(self, dashboard_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `get_dashboards_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def _get_dashboards_id_members_prepare(self, dashboard_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `get_dashboards_id_members`"
            raise ValueError(
                msg,
            )
    ...
    def _get_dashboards_id_owners_prepare(self, dashboard_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `get_dashboards_id_owners`"
            raise ValueError(
                msg,
            )
    ...
    def patch_dashboards_id(self, dashboard_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.patch_dashboards_id_with_http_info(dashboard_id, **kwargs)
        else:
            return self.patch_dashboards_id_with_http_info(dashboard_id, **kwargs)
    ...
    def _patch_dashboards_id_prepare(self, dashboard_id, **kwargs):
        local_var_params = locals()

        all_params = ["dashboard_id", "zap_trace_span", "patch_dashboard_request"]
        self._check_operation_params("patch_dashboards_id", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `patch_dashboards_id`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_dashboards_id_cells_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "cell_id", "cell_update", "zap_trace_span"]
        self._check_operation_params("patch_dashboards_id_cells_id", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `patch_dashboards_id_cells_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'cell_id' is set
        if "cell_id" not in local_var_params or local_var_params["cell_id"] is None:
            msg = "Missing the required parameter `cell_id` when calling `patch_dashboards_id_cells_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'cell_update' is set
        if "cell_update" not in local_var_params or local_var_params["cell_update"] is None:
            msg = "Missing the required parameter `cell_update` when calling `patch_dashboards_id_cells_id`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_dashboards_id_cells_id_view_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "cell_id", "view", "zap_trace_span"]
        self._check_operation_params(
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `patch_dashboards_id_cells_id_view`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'cell_id' is set
        if "cell_id" not in local_var_params or local_var_params["cell_id"] is None:
            msg = "Missing the required parameter `cell_id` when calling `patch_dashboards_id_cells_id_view`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'view' is set
        if "view" not in local_var_params or local_var_params["view"] is None:
            msg = "Missing the required parameter `view` when calling `patch_dashboards_id_cells_id_view`"
            raise ValueError(
                msg,
            )
    ...
    def _post_dashboards_prepare(self, create_dashboard_request, **kwargs):
        local_var_params = locals()

        all_params = ["create_dashboard_request", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `create_dashboard_request` when calling `post_dashboards`"
            raise ValueError(
                msg,
            )
    ...
    def _post_dashboards_id_cells_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "create_cell", "zap_trace_span"]
        self._check_operation_params("post_dashboards_id_cells", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `post_dashboards_id_cells`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'create_cell' is set
        if "create_cell" not in local_var_params or local_var_params["create_cell"] is None:
            msg = "Missing the required parameter `create_cell` when calling `post_dashboards_id_cells`"
            raise ValueError(
                msg,
            )
    ...
    def _post_dashboards_id_labels_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "label_mapping", "zap_trace_span"]
        self._check_operation_params("post_dashboards_id_labels", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `post_dashboards_id_labels`"
            raise ValueError(
                msg,
            )
        ...
        if "label_mapping" not in local_var_params or local_var_params["label_mapping"] is None:
            msg = "Missing the required parameter `label_mapping` when calling `post_dashboards_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def _post_dashboards_id_members_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `post_dashboards_id_members`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `add_resource_member_request_body` when calling `post_dashboards_id_members`"
            raise ValueError(
                msg,
            )
    ...
    def _post_dashboards_id_owners_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `post_dashboards_id_owners`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'add_resource_member_request_body' is set
        if (
            ...
            msg = "Missing the required parameter `add_resource_member_request_body` when calling `post_dashboards_id_owners`"
            raise ValueError(
                msg,
            )
    ...
    def _put_dashboards_id_cells_prepare(
        ...
        **kwargs,
        ...
        all_params = ["dashboard_id", "cell", "zap_trace_span"]
        self._check_operation_params("put_dashboards_id_cells", all_params, local_var_params)
        # verify the required parameter 'dashboard_id' is set
        if "dashboard_id" not in local_var_params or local_var_params["dashboard_id"] is None:
            msg = "Missing the required parameter `dashboard_id` when calling `put_dashboards_id_cells`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'cell' is set
        if "cell" not in local_var_params or local_var_params["cell"] is None:
            msg = "Missing the required parameter `cell` when calling `put_dashboards_id_cells`"
            raise ValueError(
                msg,
            )
