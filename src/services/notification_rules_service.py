...
class NotificationRulesService(_BaseService):
    ...
    def _create_notification_rule_prepare(
        ...
        **kwargs,
        ...
        all_params = ["post_notification_rule"]
        ...
        if (
            ...
            msg = "Missing the required parameter `post_notification_rule` when calling `create_notification_rule`"
            raise ValueError(
                msg,
            )
    ...
    def delete_notification_rules_id(self, rule_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_notification_rules_id_with_http_info(rule_id, **kwargs)
        else:
    ...
    def _delete_notification_rules_id_prepare(self, rule_id, **kwargs):
        local_var_params = locals()

        all_params = ["rule_id", "zap_trace_span"]
        ...
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            msg = "Missing the required parameter `rule_id` when calling `delete_notification_rules_id`"
            raise ValueError(
                msg,
            )
        ...
        if "rule_id" in local_var_params:
            path_params["ruleID"] = local_var_params["rule_id"]
    ...
    def _delete_notification_rules_id_labels_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["rule_id", "label_id", "zap_trace_span"]
        ...
        # verify the required parameter 'rule_id' is set
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            msg = "Missing the required parameter `rule_id` when calling `delete_notification_rules_id_labels_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'label_id' is set
        if "label_id" not in local_var_params or local_var_params["label_id"] is None:
            msg = "Missing the required parameter `label_id` when calling `delete_notification_rules_id_labels_id`"
            raise ValueError(
                msg,
            )
    ...
    def get_notification_rules(self, org_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_notification_rules_with_http_info(org_id, **kwargs)
        else:
            return self.get_notification_rules_with_http_info(org_id, **kwargs)
    ...
    def get_notification_rules_with_http_info(self, org_id, **kwargs):
        ...
        return self.api_client.call_api(
            ...
            post_params=[],
            files={},
            response_type="NotificationRules",
            auth_settings=[],
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
    ...
    def _get_notification_rules_prepare(self, org_id, **kwargs):
        local_var_params = locals()
        ...
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            msg = "Missing the required parameter `org_id` when calling `get_notification_rules`"
            raise ValueError(
                msg,
            )

        if "offset" in local_var_params and local_var_params["offset"] < 0:
            msg = "Invalid value for parameter `offset` when calling `get_notification_rules`, must be a value greater than or equal to `0`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] > 100:
            msg = "Invalid value for parameter `limit` when calling `get_notification_rules`, must be a value less than or equal to `100`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] < 1:
            msg = "Invalid value for parameter `limit` when calling `get_notification_rules`, must be a value greater than or equal to `1`"
            raise ValueError(
                msg,
            )
        if "tag" in local_var_params and not re.search(
            r"^[a-zA-Z0-9_]+:[a-zA-Z0-9_]+$",
            local_var_params["tag"],
        ):
            msg = "Invalid value for parameter `tag` when calling `get_notification_rules`, must conform to the pattern `/^[a-zA-Z0-9_]+:[a-zA-Z0-9_]+$/`"
            raise ValueError(
                msg,
            )
        path_params = {}
        ...
        if "check_id" in local_var_params:
            query_params.append(("checkID", local_var_params["check_id"]))
    ...
    def get_notification_rules_id(self, rule_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_notification_rules_id_with_http_info(rule_id, **kwargs)
        else:
            return self.get_notification_rules_id_with_http_info(rule_id, **kwargs)
    ...
    def _get_notification_rules_id_prepare(self, rule_id, **kwargs):
        local_var_params = locals()
    ...
    def _get_notification_rules_id_labels_prepare(self, rule_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'rule_id' is set
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            msg = "Missing the required parameter `rule_id` when calling `get_notification_rules_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_notification_rules_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["rule_id", "notification_rule_update", "zap_trace_span"]
        self._check_operation_params("patch_notification_rules_id", all_params, local_var_params)
        # verify the required parameter 'rule_id' is set
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            msg = "Missing the required parameter `rule_id` when calling `patch_notification_rules_id`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `notification_rule_update` when calling `patch_notification_rules_id`"
            raise ValueError(
                msg,
            )
    ...
    def _post_notification_rule_id_labels_prepare(
        ...
        **kwargs,
        ...
        all_params = ["rule_id", "label_mapping", "zap_trace_span"]
        self._check_operation_params(
        ...
        # verify the required parameter 'rule_id' is set
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            msg = "Missing the required parameter `rule_id` when calling `post_notification_rule_id_labels`"
            raise ValueError(
                msg,
            )
        ...
        if "label_mapping" not in local_var_params or local_var_params["label_mapping"] is None:
            msg = "Missing the required parameter `label_mapping` when calling `post_notification_rule_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def _put_notification_rules_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["rule_id", "notification_rule", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `notification_rule` when calling `put_notification_rules_id`"
            raise ValueError(
                msg,
            )
