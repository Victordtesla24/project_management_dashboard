...
class TasksService(_BaseService):
    ...
    def delete_tasks_id(self, task_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.delete_tasks_id_with_http_info(task_id, **kwargs)
        else:
            return self.delete_tasks_id_with_http_info(task_id, **kwargs)
    ...
    def _delete_tasks_id_prepare(self, task_id, **kwargs):
        local_var_params = locals()

        all_params = ["task_id", "zap_trace_span"]
        ...
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `delete_tasks_id`"
            raise ValueError(
                msg,
            )
        ...
        if "task_id" in local_var_params:
            path_params["taskID"] = local_var_params["task_id"]
    ...
    def _delete_tasks_id_labels_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["task_id", "label_id", "zap_trace_span"]
    ...
    def _delete_tasks_id_members_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["user_id", "task_id", "zap_trace_span"]
    ...
    def _delete_tasks_id_runs_id_prepare(self, task_id, run_id, **kwargs):
        local_var_params = locals()

        all_params = ["task_id", "run_id", "zap_trace_span"]
        self._check_operation_params("delete_tasks_id_runs_id", all_params, local_var_params)
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `delete_tasks_id_runs_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'run_id' is set
        if "run_id" not in local_var_params or local_var_params["run_id"] is None:
            msg = "Missing the required parameter `run_id` when calling `delete_tasks_id_runs_id`"
            raise ValueError(
                msg,
            )
        ...
        if "run_id" in local_var_params:
            path_params["runID"] = local_var_params["run_id"]
    ...
    def _get_tasks_prepare(self, **kwargs):
        local_var_params = locals()
        ...
        if "limit" in local_var_params and local_var_params["limit"] > 500:
            msg = "Invalid value for parameter `limit` when calling `get_tasks`, must be a value less than or equal to `500`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] < 1:
            msg = "Invalid value for parameter `limit` when calling `get_tasks`, must be a value greater than or equal to `1`"
            raise ValueError(
                msg,
            )
        path_params = {}
    ...
    def get_tasks_id(self, task_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_with_http_info(task_id, **kwargs)
        else:
            return self.get_tasks_id_with_http_info(task_id, **kwargs)
    ...
    def _get_tasks_id_prepare(self, task_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id`"
            raise ValueError(
                msg,
            )
    ...
    def get_tasks_id_labels(self, task_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_labels_with_http_info(task_id, **kwargs)
        else:
            return self.get_tasks_id_labels_with_http_info(task_id, **kwargs)
    ...
    def _get_tasks_id_labels_prepare(self, task_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def get_tasks_id_logs(self, task_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_logs_with_http_info(task_id, **kwargs)
        else:
            return self.get_tasks_id_logs_with_http_info(task_id, **kwargs)
    ...
    def _get_tasks_id_logs_prepare(self, task_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id_logs`"
            raise ValueError(
                msg,
            )
    ...
    def get_tasks_id_members(self, task_id, **kwargs):
        ...
        **Deprecated**: Tasks don't use `owner` and `member` roles. Use [`/api/v2/authorizations`](#tag/Authorizations-(API-tokens)) to assign user permissions.  Lists all users that have the `member` role for the specified [task](https://docs.influxdata.com/influxdb/latest/reference/glossary/#task).
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_members_with_http_info(task_id, **kwargs)
        else:
            return self.get_tasks_id_members_with_http_info(task_id, **kwargs)
    ...
    def _get_tasks_id_members_prepare(self, task_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id_members`"
            raise ValueError(
                msg,
            )
    ...
    def get_tasks_id_owners(self, task_id, **kwargs):
        ...
        **Deprecated**: Tasks don't use `owner` and `member` roles. Use [`/api/v2/authorizations`](#tag/Authorizations-(API-tokens)) to assign user permissions.  Retrieves all users that have owner permission for a task.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_owners_with_http_info(task_id, **kwargs)
        else:
            return self.get_tasks_id_owners_with_http_info(task_id, **kwargs)
    ...
    def _get_tasks_id_owners_prepare(self, task_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id_owners`"
            raise ValueError(
                msg,
            )
    ...
    def get_tasks_id_runs(self, task_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_runs_with_http_info(task_id, **kwargs)
        else:
            return self.get_tasks_id_runs_with_http_info(task_id, **kwargs)
    ...
    def _get_tasks_id_runs_prepare(self, task_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id_runs`"
            raise ValueError(
                msg,
            )

        if "limit" in local_var_params and local_var_params["limit"] > 500:
            msg = "Invalid value for parameter `limit` when calling `get_tasks_id_runs`, must be a value less than or equal to `500`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] < 1:
            msg = "Invalid value for parameter `limit` when calling `get_tasks_id_runs`, must be a value greater than or equal to `1`"
            raise ValueError(
                msg,
            )
        path_params = {}
        ...
        if "after_time" in local_var_params:
            query_params.append(("afterTime", local_var_params["after_time"]))
        if "before_time" in local_var_params:
            query_params.append(("beforeTime", local_var_params["before_time"]))
    ...
    def get_tasks_id_runs_id(self, task_id, run_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_tasks_id_runs_id_with_http_info(task_id, run_id, **kwargs)
        else:
    ...
    def _get_tasks_id_runs_id_prepare(self, task_id, run_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `get_tasks_id_runs_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'run_id' is set
        if "run_id" not in local_var_params or local_var_params["run_id"] is None:
            msg = "Missing the required parameter `run_id` when calling `get_tasks_id_runs_id`"
            raise ValueError(
                msg,
            )
    ...
    def _get_tasks_id_runs_id_logs_prepare(self, task_id, run_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'run_id' is set
        if "run_id" not in local_var_params or local_var_params["run_id"] is None:
            msg = "Missing the required parameter `run_id` when calling `get_tasks_id_runs_id_logs`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_tasks_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["task_id", "task_update_request", "zap_trace_span"]
        self._check_operation_params("patch_tasks_id", all_params, local_var_params)
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `patch_tasks_id`"
            raise ValueError(
                msg,
            )
    ...
    def post_tasks(self, task_create_request, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_tasks_with_http_info(task_create_request, **kwargs)
        else:
            return self.post_tasks_with_http_info(task_create_request, **kwargs)
    ...
    def _post_tasks_prepare(self, task_create_request, **kwargs):
        local_var_params = locals()

        all_params = ["task_create_request", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `task_create_request` when calling `post_tasks`"
            raise ValueError(
                msg,
            )
    ...
    def _post_tasks_id_labels_prepare(
        ...
        **kwargs,
        ...
        all_params = ["task_id", "label_mapping", "zap_trace_span"]
        self._check_operation_params("post_tasks_id_labels", all_params, local_var_params)
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `post_tasks_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def _post_tasks_id_members_prepare(
        ...
        **kwargs,
        ...
        all_params = ["task_id", "add_resource_member_request_body", "zap_trace_span"]
        self._check_operation_params("post_tasks_id_members", all_params, local_var_params)
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `post_tasks_id_members`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `add_resource_member_request_body` when calling `post_tasks_id_members`"
            raise ValueError(
                msg,
            )
    ...
    def _post_tasks_id_owners_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `post_tasks_id_owners`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'add_resource_member_request_body' is set
        if (
            ...
            msg = "Missing the required parameter `add_resource_member_request_body` when calling `post_tasks_id_owners`"
            raise ValueError(
                msg,
            )
    ...
    def post_tasks_id_runs(self, task_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_tasks_id_runs_with_http_info(task_id, **kwargs)
        else:
            return self.post_tasks_id_runs_with_http_info(task_id, **kwargs)
    ...
    def _post_tasks_id_runs_prepare(self, task_id, **kwargs):
        local_var_params = locals()

        all_params = ["task_id", "zap_trace_span", "run_manually"]
        self._check_operation_params("post_tasks_id_runs", all_params, local_var_params)
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `post_tasks_id_runs`"
            raise ValueError(
                msg,
            )
    ...
    def _post_tasks_id_runs_id_retry_prepare(
        ...
        **kwargs,
        ...
        all_params = ["task_id", "run_id", "zap_trace_span", "body"]
        self._check_operation_params("post_tasks_id_runs_id_retry", all_params, local_var_params)
        # verify the required parameter 'task_id' is set
        if "task_id" not in local_var_params or local_var_params["task_id"] is None:
            msg = "Missing the required parameter `task_id` when calling `post_tasks_id_runs_id_retry`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'run_id' is set
