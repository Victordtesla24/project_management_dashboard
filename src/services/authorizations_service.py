...
class AuthorizationsService(_BaseService):
    ...
    def delete_authorizations_id(self, auth_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.delete_authorizations_id_with_http_info(auth_id, **kwargs)
        else:
            return self.delete_authorizations_id_with_http_info(auth_id, **kwargs)
    ...
    def _delete_authorizations_id_prepare(self, auth_id, **kwargs):
        ...
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `delete_authorizations_id`"
            raise ValueError(
                msg,
            )
    ...
    def get_authorizations(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_authorizations_with_http_info(**kwargs)
        else:
            return self.get_authorizations_with_http_info(**kwargs)
    ...
    def _get_authorizations_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["zap_trace_span", "user_id", "user", "org_id", "org", "token"]
    ...
    def get_authorizations_id(self, auth_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_authorizations_id_with_http_info(auth_id, **kwargs)
        else:
            return self.get_authorizations_id_with_http_info(auth_id, **kwargs)
    ...
    def _get_authorizations_id_prepare(self, auth_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'auth_id' is set
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `get_authorizations_id`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_authorizations_id_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'auth_id' is set
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `patch_authorizations_id`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `authorization_update_request` when calling `patch_authorizations_id`"
            raise ValueError(
                msg,
            )
    ...
    def _post_authorizations_prepare(
        ...
        **kwargs,
        ...
        all_params = ["authorization_post_request", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `authorization_post_request` when calling `post_authorizations`"
            raise ValueError(
                msg,
            )
