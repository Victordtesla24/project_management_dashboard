...
class BucketSchemasService(_BaseService):
    ...
    def create_measurement_schema_with_http_info(
        ...
        **kwargs,
        ...
        return self.api_client.call_api(
            ...
            post_params=[],
            files={},
            response_type="MeasurementSchema",
            auth_settings=[],
    ...
    def _create_measurement_schema_prepare(
        ...
        **kwargs,
        ...
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `create_measurement_schema`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `measurement_schema_create_request` when calling `create_measurement_schema`"
            raise ValueError(
                msg,
            )
    ...
    def _get_measurement_schema_prepare(
        ...
        **kwargs,
        ...
        all_params = ["bucket_id", "measurement_id", "org", "org_id"]
        self._check_operation_params("get_measurement_schema", all_params, local_var_params)
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `get_measurement_schema`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'measurement_id' is set
        if "measurement_id" not in local_var_params or local_var_params["measurement_id"] is None:
            msg = "Missing the required parameter `measurement_id` when calling `get_measurement_schema`"
            raise ValueError(
                msg,
            )
        ...
        if "measurement_id" in local_var_params:
            path_params["measurementID"] = local_var_params["measurement_id"]
    ...
    def get_measurement_schemas(self, bucket_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_measurement_schemas_with_http_info(bucket_id, **kwargs)
        else:
            return self.get_measurement_schemas_with_http_info(bucket_id, **kwargs)
    ...
    def get_measurement_schemas_with_http_info(self, bucket_id, **kwargs):
        ...
        return self.api_client.call_api(
            ...
            post_params=[],
            files={},
            response_type="MeasurementSchemaList",
            auth_settings=[],
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
    ...
    def _get_measurement_schemas_prepare(self, bucket_id, **kwargs):
        local_var_params = locals()

        all_params = ["bucket_id", "org", "org_id", "name"]
    ...
    def _update_measurement_schema_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `update_measurement_schema`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'measurement_id' is set
        if "measurement_id" not in local_var_params or local_var_params["measurement_id"] is None:
            msg = "Missing the required parameter `measurement_id` when calling `update_measurement_schema`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `measurement_schema_update_request` when calling `update_measurement_schema`"
            raise ValueError(
                msg,
            )
