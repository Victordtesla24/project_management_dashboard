...
class QueryService(_BaseService):
    ...
    def get_query_suggestions(self, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.get_query_suggestions_with_http_info(**kwargs)
        else:
            return self.get_query_suggestions_with_http_info(**kwargs)
    ...
    def _get_query_suggestions_prepare(self, **kwargs):
    ...
    def get_query_suggestions_name(self, name, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_query_suggestions_name_with_http_info(name, **kwargs)
        else:
            return self.get_query_suggestions_name_with_http_info(name, **kwargs)
    ...
    def _get_query_suggestions_name_prepare(self, name, **kwargs):
        local_var_params = locals()

        all_params = ["name", "zap_trace_span"]
        ...
        if "name" not in local_var_params or local_var_params["name"] is None:
            msg = "Missing the required parameter `name` when calling `get_query_suggestions_name`"
            raise ValueError(
                msg,
            )
    ...
    def post_query(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_query_with_http_info(**kwargs)
        else:
            return self.post_query_with_http_info(**kwargs)
    ...
    def _post_query_prepare(self, **kwargs):
        local_var_params = locals()
    ...
    def post_query_analyze(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_query_analyze_with_http_info(**kwargs)
        else:
            return self.post_query_analyze_with_http_info(**kwargs)
    ...
    def post_query_analyze_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(
            ...
            post_params=[],
            files={},
            response_type="AnalyzeQueryResponse",
            auth_settings=[],
            async_req=local_var_params.get("async_req"),
            _return_http_data_only=local_var_params.get("_return_http_data_only"),
            _preload_content=local_var_params.get("_preload_content", True),
    ...
    def _post_query_analyze_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["zap_trace_span", "content_type", "query"]
    ...
    def post_query_ast(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_query_ast_with_http_info(**kwargs)
        else:
            return self.post_query_ast_with_http_info(**kwargs)
    ...
    def _post_query_ast_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["zap_trace_span", "content_type", "language_request"]
