...
class SetupService(_BaseService):
    ...
    def get_setup(self, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.get_setup_with_http_info(**kwargs)
        else:
            return self.get_setup_with_http_info(**kwargs)
    ...
    def _get_setup_prepare(self, **kwargs):
    ...
    def post_setup(self, onboarding_request, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_setup_with_http_info(onboarding_request, **kwargs)
        else:
            return self.post_setup_with_http_info(onboarding_request, **kwargs)
    ...
    def _post_setup_prepare(self, onboarding_request, **kwargs):
        local_var_params = locals()

        all_params = ["onboarding_request", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `onboarding_request` when calling `post_setup`"
            raise ValueError(
                msg,
            )
