...
class DeleteService(_BaseService):
    ...
    def post_delete(self, delete_predicate_request, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.post_delete_with_http_info(delete_predicate_request, **kwargs)
        else:
    ...
    def _post_delete_prepare(self, delete_predicate_request, **kwargs):
        ...
        if (
            ...
            msg = "Missing the required parameter `delete_predicate_request` when calling `post_delete`"
            raise ValueError(
                msg,
            )
