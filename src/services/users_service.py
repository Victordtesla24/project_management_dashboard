...
class UsersService(_BaseService):
    ...
    def delete_users_id(self, user_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.delete_users_id_with_http_info(user_id, **kwargs)
        else:
            return self.delete_users_id_with_http_info(user_id, **kwargs)
    ...
    def _delete_users_id_prepare(self, user_id, **kwargs):
        local_var_params = locals()

        all_params = ["user_id", "zap_trace_span"]
        ...
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `delete_users_id`"
            raise ValueError(
                msg,
            )
    ...
    def _get_me_prepare(self, **kwargs):
        local_var_params = locals()
    ...
    def _get_users_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["zap_trace_span", "offset", "limit", "after", "name", "id"]
        ...
        if "offset" in local_var_params and local_var_params["offset"] < 0:
            msg = "Invalid value for parameter `offset` when calling `get_users`, must be a value greater than or equal to `0`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] > 100:
            msg = "Invalid value for parameter `limit` when calling `get_users`, must be a value less than or equal to `100`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] < 1:
            msg = "Invalid value for parameter `limit` when calling `get_users`, must be a value greater than or equal to `1`"
            raise ValueError(
                msg,
            )
        path_params = {}
    ...
    def get_users_id(self, user_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_users_id_with_http_info(user_id, **kwargs)
        else:
            return self.get_users_id_with_http_info(user_id, **kwargs)
    ...
    def _get_users_id_prepare(self, user_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'user_id' is set
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `get_users_id`"
            raise ValueError(
                msg,
            )
    ...
    def patch_users_id(self, user_id, user, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.patch_users_id_with_http_info(user_id, user, **kwargs)
        else:
            return self.patch_users_id_with_http_info(user_id, user, **kwargs)
    ...
    def _patch_users_id_prepare(self, user_id, user, **kwargs):
        local_var_params = locals()

        all_params = ["user_id", "user", "zap_trace_span"]
        self._check_operation_params("patch_users_id", all_params, local_var_params)
        # verify the required parameter 'user_id' is set
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `patch_users_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'user' is set
        if "user" not in local_var_params or local_var_params["user"] is None:
            msg = "Missing the required parameter `user` when calling `patch_users_id`"
            raise ValueError(
                msg,
            )
    ...
    def post_users(self, user, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_users_with_http_info(user, **kwargs)
        else:
            return self.post_users_with_http_info(user, **kwargs)
    ...
    def _post_users_prepare(self, user, **kwargs):
        local_var_params = locals()

        all_params = ["user", "zap_trace_span"]
        self._check_operation_params("post_users", all_params, local_var_params)
        # verify the required parameter 'user' is set
        if "user" not in local_var_params or local_var_params["user"] is None:
            msg = "Missing the required parameter `user` when calling `post_users`"
            raise ValueError(
                msg,
            )
    ...
    def _post_users_id_password_prepare(
        ...
        **kwargs,
        ...
        all_params = ["user_id", "password_reset_body", "zap_trace_span"]
        self._check_operation_params("post_users_id_password", all_params, local_var_params)
        # verify the required parameter 'user_id' is set
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `post_users_id_password`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `password_reset_body` when calling `post_users_id_password`"
            raise ValueError(
                msg,
            )
    ...
    def put_me_password(self, password_reset_body, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.put_me_password_with_http_info(password_reset_body, **kwargs)
        else:
    ...
    def _put_me_password_prepare(self, password_reset_body, **kwargs):
        local_var_params = locals()

        all_params = ["password_reset_body", "zap_trace_span", "authorization"]
        ...
        if (
            ...
            msg = "Missing the required parameter `password_reset_body` when calling `put_me_password`"
            raise ValueError(
                msg,
            )
    ...
    def _put_users_id_password_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'user_id' is set
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `put_users_id_password`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'password_reset_body' is set
        if (
            ...
            msg = "Missing the required parameter `password_reset_body` when calling `put_users_id_password`"
            raise ValueError(
                msg,
            )
