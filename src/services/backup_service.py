...
class BackupService(_BaseService):
    ...
    def get_backup_kv(self, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.get_backup_kv_with_http_info(**kwargs)
        else:
            return self.get_backup_kv_with_http_info(**kwargs)
    ...
    def _get_backup_kv_prepare(self, **kwargs):
    ...
    def get_backup_metadata(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_backup_metadata_with_http_info(**kwargs)
        else:
            return self.get_backup_metadata_with_http_info(**kwargs)
    ...
    def _get_backup_metadata_prepare(self, **kwargs):
        local_var_params = locals()

        all_params = ["zap_trace_span", "accept_encoding"]
    ...
    def get_backup_shard_id(self, shard_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_backup_shard_id_with_http_info(shard_id, **kwargs)
        else:
            return self.get_backup_shard_id_with_http_info(shard_id, **kwargs)
    ...
    def _get_backup_shard_id_prepare(self, shard_id, **kwargs):
        local_var_params = locals()

        all_params = ["shard_id", "zap_trace_span", "accept_encoding", "since"]
        ...
        if "shard_id" not in local_var_params or local_var_params["shard_id"] is None:
            msg = "Missing the required parameter `shard_id` when calling `get_backup_shard_id`"
            raise ValueError(
                msg,
            )
