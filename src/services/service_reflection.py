...
class _ServiceBuilder:
    ...
    def _CallMethod(self, srvc, method_descriptor, rpc_controller, request, callback):
        ...
        if method_descriptor.containing_service != self.descriptor:
            msg = "CallMethod() given method descriptor for wrong service type."
    ...
    def _GetRequestClass(self, method_descriptor):
        ...
        """
        if method_descriptor.containing_service != self.descriptor:
            msg = "GetRequestClass() given method descriptor for wrong service type."
            raise RuntimeError(msg)
    ...
    def _GetResponseClass(self, method_descriptor):
        ...
        """
        if method_descriptor.containing_service != self.descriptor:
            msg = "GetResponseClass() given method descriptor for wrong service type."
            raise RuntimeError(msg)
