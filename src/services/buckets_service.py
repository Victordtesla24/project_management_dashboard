...
class BucketsService(_BaseService):
    ...
    def delete_buckets_id(self, bucket_id, **kwargs):
        ...
        if kwargs.get("async_req"):
            return self.delete_buckets_id_with_http_info(bucket_id, **kwargs)
        else:
            return self.delete_buckets_id_with_http_info(bucket_id, **kwargs)
    ...
    def _delete_buckets_id_prepare(self, bucket_id, **kwargs):
        local_var_params = locals()

        all_params = ["bucket_id", "zap_trace_span"]
        ...
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `delete_buckets_id`"
            raise ValueError(
                msg,
            )
        ...
        if "bucket_id" in local_var_params:
            path_params["bucketID"] = local_var_params["bucket_id"]
    ...
    def _delete_buckets_id_labels_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["bucket_id", "label_id", "zap_trace_span"]
        self._check_operation_params("delete_buckets_id_labels_id", all_params, local_var_params)
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `delete_buckets_id_labels_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'label_id' is set
        if "label_id" not in local_var_params or local_var_params["label_id"] is None:
            msg = "Missing the required parameter `label_id` when calling `delete_buckets_id_labels_id`"
            raise ValueError(
                msg,
            )
    ...
    def _delete_buckets_id_members_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["user_id", "bucket_id", "zap_trace_span"]
        ...
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `delete_buckets_id_members_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `delete_buckets_id_members_id`"
            raise ValueError(
                msg,
            )
    ...
    def _delete_buckets_id_owners_id_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'user_id' is set
        if "user_id" not in local_var_params or local_var_params["user_id"] is None:
            msg = "Missing the required parameter `user_id` when calling `delete_buckets_id_owners_id`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `delete_buckets_id_owners_id`"
            raise ValueError(
                msg,
            )
    ...
    def _get_buckets_prepare(self, **kwargs):
        local_var_params = locals()
        ...
        if "offset" in local_var_params and local_var_params["offset"] < 0:
            msg = "Invalid value for parameter `offset` when calling `get_buckets`, must be a value greater than or equal to `0`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] > 100:
            msg = "Invalid value for parameter `limit` when calling `get_buckets`, must be a value less than or equal to `100`"
            raise ValueError(
                msg,
            )
        if "limit" in local_var_params and local_var_params["limit"] < 1:
            msg = "Invalid value for parameter `limit` when calling `get_buckets`, must be a value greater than or equal to `1`"
            raise ValueError(
                msg,
            )
        path_params = {}
    ...
    def get_buckets_id(self, bucket_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_buckets_id_with_http_info(bucket_id, **kwargs)
        else:
            return self.get_buckets_id_with_http_info(bucket_id, **kwargs)
    ...
    def _get_buckets_id_prepare(self, bucket_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `get_buckets_id`"
            raise ValueError(
                msg,
            )
    ...
    def get_buckets_id_labels(self, bucket_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_buckets_id_labels_with_http_info(bucket_id, **kwargs)
        else:
            return self.get_buckets_id_labels_with_http_info(bucket_id, **kwargs)
    ...
    def _get_buckets_id_labels_prepare(self, bucket_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `get_buckets_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def get_buckets_id_members(self, bucket_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_buckets_id_members_with_http_info(bucket_id, **kwargs)
        else:
            return self.get_buckets_id_members_with_http_info(bucket_id, **kwargs)
    ...
    def _get_buckets_id_members_prepare(self, bucket_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `get_buckets_id_members`"
            raise ValueError(
                msg,
            )
    ...
    def get_buckets_id_owners(self, bucket_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_buckets_id_owners_with_http_info(bucket_id, **kwargs)
        else:
            return self.get_buckets_id_owners_with_http_info(bucket_id, **kwargs)
    ...
    def _get_buckets_id_owners_prepare(self, bucket_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `get_buckets_id_owners`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_buckets_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["bucket_id", "patch_bucket_request", "zap_trace_span"]
        self._check_operation_params("patch_buckets_id", all_params, local_var_params)
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `patch_buckets_id`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `patch_bucket_request` when calling `patch_buckets_id`"
            raise ValueError(
                msg,
            )
    ...
    def post_buckets(self, post_bucket_request, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.post_buckets_with_http_info(post_bucket_request, **kwargs)
        else:
            return self.post_buckets_with_http_info(post_bucket_request, **kwargs)
    ...
    def _post_buckets_prepare(self, post_bucket_request, **kwargs):
        local_var_params = locals()

        all_params = ["post_bucket_request", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `post_bucket_request` when calling `post_buckets`"
            raise ValueError(
                msg,
            )
    ...
    def _post_buckets_id_labels_prepare(
        ...
        **kwargs,
        ...
        all_params = ["bucket_id", "label_mapping", "zap_trace_span"]
        self._check_operation_params("post_buckets_id_labels", all_params, local_var_params)
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `post_buckets_id_labels`"
            raise ValueError(
                msg,
            )
        ...
        if "label_mapping" not in local_var_params or local_var_params["label_mapping"] is None:
            msg = "Missing the required parameter `label_mapping` when calling `post_buckets_id_labels`"
            raise ValueError(
                msg,
            )
    ...
    def _post_buckets_id_members_prepare(
        ...
        **kwargs,
        ...
        if (
            ...
            msg = "Missing the required parameter `add_resource_member_request_body` when calling `post_buckets_id_members`"
            raise ValueError(
                msg,
            )
    ...
    def _post_buckets_id_owners_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'bucket_id' is set
        if "bucket_id" not in local_var_params or local_var_params["bucket_id"] is None:
            msg = "Missing the required parameter `bucket_id` when calling `post_buckets_id_owners`"
            raise ValueError(
                msg,
            )
        # verify the required parameter 'add_resource_member_request_body' is set
        if (
            ...
            msg = "Missing the required parameter `add_resource_member_request_body` when calling `post_buckets_id_owners`"
            raise ValueError(
                msg,
            )
