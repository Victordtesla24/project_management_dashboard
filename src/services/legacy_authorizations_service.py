...
class LegacyAuthorizationsService(_BaseService):
    ...
    def _delete_legacy_authorizations_id_prepare(self, auth_id, **kwargs):
        local_var_params = locals()

        all_params = ["auth_id", "zap_trace_span"]
        self._check_operation_params(
            "delete_legacy_authorizations_id",
            all_params,
            local_var_params,
        )
        # verify the required parameter 'auth_id' is set
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `delete_legacy_authorizations_id`"
            raise ValueError(
                msg,
            )
        ...
        if "auth_id" in local_var_params:
            path_params["authID"] = local_var_params["auth_id"]
    ...
    def get_legacy_authorizations(self, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_legacy_authorizations_with_http_info(**kwargs)
        else:
            return self.get_legacy_authorizations_with_http_info(**kwargs)
    ...
    def _get_legacy_authorizations_prepare(self, **kwargs):
        local_var_params = locals()
        ...
        if "auth_id" in local_var_params:
            query_params.append(("authID", local_var_params["auth_id"]))
    ...
    def get_legacy_authorizations_id(self, auth_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_legacy_authorizations_id_with_http_info(auth_id, **kwargs)
        else:
    ...
    def _get_legacy_authorizations_id_prepare(self, auth_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'auth_id' is set
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `get_legacy_authorizations_id`"
            raise ValueError(
                msg,
            )
    ...
    def _patch_legacy_authorizations_id_prepare(
        ...
        **kwargs,
        ...
        all_params = ["auth_id", "authorization_update_request", "zap_trace_span"]
        self._check_operation_params("patch_legacy_authorizations_id", all_params, local_var_params)
        # verify the required parameter 'auth_id' is set
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `patch_legacy_authorizations_id`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `authorization_update_request` when calling `patch_legacy_authorizations_id`"
            raise ValueError(
                msg,
            )
    ...
    def _post_legacy_authorizations_prepare(
        ...
        **kwargs,
        ...
        all_params = ["legacy_authorization_post_request", "zap_trace_span"]
        ...
        if (
            ...
            msg = "Missing the required parameter `legacy_authorization_post_request` when calling `post_legacy_authorizations`"
            raise ValueError(
                msg,
            )
    ...
    def _post_legacy_authorizations_id_password_prepare(
        ...
        **kwargs,
        ...
        all_params = ["auth_id", "password_reset_body", "zap_trace_span"]
        self._check_operation_params(
            "post_legacy_authorizations_id_password",
            all_params,
            local_var_params,
        )
        # verify the required parameter 'auth_id' is set
        if "auth_id" not in local_var_params or local_var_params["auth_id"] is None:
            msg = "Missing the required parameter `auth_id` when calling `post_legacy_authorizations_id_password`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `password_reset_body` when calling `post_legacy_authorizations_id_password`"
            raise ValueError(
                msg,
            )
