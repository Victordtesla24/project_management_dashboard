...
class RulesService(_BaseService):
    ...
    def _get_notification_rules_id_query_prepare(self, rule_id, **kwargs):
        ...
        if "rule_id" not in local_var_params or local_var_params["rule_id"] is None:
            msg = "Missing the required parameter `rule_id` when calling `get_notification_rules_id_query`"
            raise ValueError(
                msg,
            )
