...
class ReplicationsService(_BaseService):
    ...
    def _delete_replication_by_id_prepare(self, replication_id, **kwargs):
        local_var_params = locals()

        all_params = ["replication_id", "zap_trace_span"]
        ...
        if "replication_id" not in local_var_params or local_var_params["replication_id"] is None:
            msg = "Missing the required parameter `replication_id` when calling `delete_replication_by_id`"
            raise ValueError(
                msg,
            )
        ...
        if "replication_id" in local_var_params:
            path_params["replicationID"] = local_var_params["replication_id"]
    ...
    def get_replication_by_id(self, replication_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_replication_by_id_with_http_info(replication_id, **kwargs)
        else:
    ...
    def _get_replication_by_id_prepare(self, replication_id, **kwargs):
        local_var_params = locals()
        ...
        # verify the required parameter 'replication_id' is set
        if "replication_id" not in local_var_params or local_var_params["replication_id"] is None:
            msg = "Missing the required parameter `replication_id` when calling `get_replication_by_id`"
            raise ValueError(
                msg,
            )
    ...
    def get_replications(self, org_id, **kwargs):
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_replications_with_http_info(org_id, **kwargs)
        else:
            return self.get_replications_with_http_info(org_id, **kwargs)
    ...
    def _get_replications_prepare(self, org_id, **kwargs):
        local_var_params = locals()
        ...
        if "org_id" not in local_var_params or local_var_params["org_id"] is None:
            msg = "Missing the required parameter `org_id` when calling `get_replications`"
            raise ValueError(
                msg,
            )
        ...
        if "remote_id" in local_var_params:
            query_params.append(("remoteID", local_var_params["remote_id"]))
    ...
    def _patch_replication_by_id_prepare(
        ...
        **kwargs,
        ...
        # verify the required parameter 'replication_id' is set
        if "replication_id" not in local_var_params or local_var_params["replication_id"] is None:
            msg = "Missing the required parameter `replication_id` when calling `patch_replication_by_id`"
            raise ValueError(
                msg,
            )
        ...
        if (
            ...
            msg = "Missing the required parameter `replication_update_request` when calling `patch_replication_by_id`"
            raise ValueError(
                msg,
            )
    ...
    def _post_replication_prepare(
        ...
        **kwargs,
        ...
        all_params = ["replication_creation_request", "zap_trace_span", "validate"]
        ...
        if (
            ...
            msg = "Missing the required parameter `replication_creation_request` when calling `post_replication`"
            raise ValueError(
                msg,
            )
    ...
    def _post_validate_replication_by_id_prepare(
        ...
        **kwargs,
        ...
        self._check_operation_params(
            "post_validate_replication_by_id",
            all_params,
            local_var_params,
        )
        # verify the required parameter 'replication_id' is set
        if "replication_id" not in local_var_params or local_var_params["replication_id"] is None:
            msg = "Missing the required parameter `replication_id` when calling `post_validate_replication_by_id`"
            raise ValueError(
                msg,
            )
