...
class ModelicaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"(block|class|connector|end|function|model|operator|package|record|type)\b",
                Keyword.Reserved,
                "class",
            ),
...
class StanLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"({})(\s*)(\{{)".format(
                    "functions|data|transformed\\s+?data|parameters|transformed\\s+parameters|model|generated\\s+quantities",
                ),
