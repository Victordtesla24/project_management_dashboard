...
class Node:
    ...
    def __init__(self, lineno, col_offset=0) -> None:
        self.lineno = lineno
...
class TestIterSourceCode(TestCase):
    ...
    def test_emptyDirectory(self):
        ...
        assert list(iterSourceCode([self.tempdir])) == []
    ...
    def test_singleFile(self):
        ...
        assert list(iterSourceCode([self.tempdir])) == [childpath]
    ...
    def test_recurses(self):
        ...
        assert sorted(iterSourceCode([self.tempdir])) == sorted([apath, bpath, cpath])
    ...
    def test_shebang(self):
        ...
        assert sorted(iterSourceCode([self.tempdir])) == sorted(
    ...
    def test_multipleDirectories(self):
        ...
        os.mkdir(barpath)
        bpath = self.makeEmptyFile("bar", "b.py")
        assert sorted(iterSourceCode([foopath, barpath])) == sorted([apath, bpath])
    ...
    def test_explicitFiles(self):
        ...
        assert list(iterSourceCode([epath])) == [epath]
...
class TestReporter(TestCase):
    ...
    def test_syntaxError(self):
        ...
        assert err.getvalue() == "foo.py:3:8: a problem\nbad line of source\n       ^\n"
    ...
    def test_syntaxErrorNoOffset(self):
        ...
        assert err.getvalue() == "foo.py:3: a problem\nbad line of source\n"
    ...
    def test_syntaxErrorNoText(self):
        ...
        assert err.getvalue() == "<stdin>:1:1: a problem\n"
    ...
    def test_unexpectedError(self):
        ...
        assert err.getvalue() == "source.py: error message\n"
...
class CheckTests(TestCase):
    ...
    def assertHasErrors(self, path, errorList):
        ...
        assert (count, err.getvalue()) == (len(errorList), "".join(errorList))
    ...
    def test_legacyScript(self):
        ...
        assert script_pyflakes.checkPath is checkPath
    ...
    def test_checkPathNonExisting(self):
        ...
        assert count == 1
        assert errors == [("unexpectedError", "extremo", "No such file or directory")]
...
%s""" % (
    ...
    def test_permissionDenied(self):
        ...
        with self.makeTempFile("") as sourcePath:
            ...
            assert count == 1
            assert errors == [("unexpectedError", sourcePath, "Permission denied")]
...
"""
    ...
    def test_stdinReportsErrors(self):
        ...
        assert errlines == expected_error
...
class IntegrationTests(TestCase):
    ...
    def test_fileWithFlakes(self):
        ...
        assert d == (f"{expected}{os.linesep}", "", 1)
