    ...
    * |st.testing.v1.AppTest.from_function|_
    ...
    def _from_string(
        ...
        *,
        ...
        return AppTest(str(path), default_timeout=default_timeout, args=args, kwargs=kwargs)
    ...
    def from_function(
        ...
        *,
        ...
        return cls._from_string(module, default_timeout=default_timeout, args=args, kwargs=kwargs)

    @classmethod
    def from_file(cls, script_path: str | Path, *, default_timeout: float = 3) -> AppTest:
        """Create an instance of ``AppTest`` to simulate an app page defined\
        within a file.
    ...
    def switch_page(self, page_path: str) -> AppTest:
        ...
        if not full_page_path.is_file():
            msg = f"Unable to find script at {page_path}, make sure the page given is relative to the main script."
            raise ValueError(
                msg,
            )
